...
% intelligible for later preprocessing.
    ...
    unix('mv ./epi_mb_3x3x3_400TR_Resting_Physio_pre_* ./data.functional.rest_pre');
    unix('mv ./epi_mb_3x3x3_400TR_Resting_Physio_post_* ./data.functional.rest_post');
    unix('mv ./epi_mb_3x3x3_400TR_Gra_Physio_pre_* ./data.functional.task_pre');
    unix('mv ./epi_mb_3x3x3_400TR_Gra_Physio_post_* ./data.functional.task_post');
